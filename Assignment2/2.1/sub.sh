...
echo `date`
mpirun -l -machinefile hostfile -np 8 ./src-pp.x 512 
mpirun -l -machinefile hostfile -np 16 ./src-pp.x 512
mpirun -l -machinefile hostfile -np 32 ./src-pp.x 512
mpirun -l -machinefile hostfile -np 64 ./src-pp.x 512
mpirun -l -machinefile hostfile -np 128 ./src-pp.x 512
# echo `date`
